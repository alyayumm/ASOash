...
const directionCards = [
  ...
  },
  {
    ...
    text: 'Проектируем маршрут запуска: продвижение, экономика, команда и первые управленческие правила.',
    image: directionLaunchBg,
  },
  {
    id: 'franchise',
    label: 'Франшиза',
    title: 'Купить франшизу АСО',
    text: 'Подключаем запуск по готовой модели: бренд, стандарты, процессы и сопровождение.',
